...
plot1 =
  ...
  labs(title="(A) Total Energy Consumption per Smartphone by World Bank Income Group.",
       fill=NULL,
       subtitle = "Reported for the IEA Announced Policy Scenario 2030.",
       x = NULL, y="Kilowatt Hours Per Smartphone")  +
...
plot2 =
  ...
  labs(title="(B) Total Energy Consumption per Smartphone by World Bank Region.",
       fill=NULL,
       subtitle = "Reported for the IEA Announced Policy Scenario 2030.",
       x = NULL, y="Kilowatt Hours Per Smartphone")  +
  scale_y_continuous(expand = c(0, 0), limits = c(0, max_value)) +
...
dir.create(file.path(folder, 'figures'), showWarnings = FALSE)
path = file.path(folder, 'figures', 'energy_panel_per_smartphone.png')
...
plot3 =
  ...
  theme(legend.position = 'bottom',
        axis.text.x = element_text(angle = 45, hjust=1)) +
  labs(title="Total Energy Consumption per Smartphone by World Bank Income Group",
       fill=NULL,
       subtitle = "Reported for the IEA Announced Policy Scenario 2030.",
       x = NULL, y="Kilowatt Hours Per Smartphone")  +
  scale_y_continuous(expand = c(0, 0), limits = c(0, max_value)) +
...
plot4 =
  ...
  theme(legend.position = 'bottom',
        axis.text.x = element_text(angle = 45, hjust=1)) +
  labs(title="Total Mobile Site Energy Consumption by World Bank Region",
       fill=NULL,
       subtitle = "Reported for the IEA Announced Policy Scenario 2030.",
       x = NULL, y="Kilowatt Hours Per Smartphone") +
  scale_y_continuous(expand = c(0, 0), limits = c(0, max_value)) +
