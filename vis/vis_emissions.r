...
filename = 'energy_technology_options.csv'
...
data <- select(data, scenario_adopt, scenario_capacity, strategy_short, 
               on_grid_demand_carbon_per_kwh, 
               on_grid_nitrogen_oxide_per_kwh,
               on_grid_sulpher_dioxide_per_kwh,
               on_grid_pm10_per_kwh,
               off_grid_demand_carbon_per_kwh,
               off_grid_nitrogen_oxide_per_kwh,
               off_grid_sulpher_dioxide_per_kwh,
               off_grid_pm10_per_kwh
               )
...
ggplot(data, aes(y=value, x=strategy_short)) + 
  ...
  facet_grid(scenario_capacity~metric)
