...
if __name__ == '__main__':
    ...
    MODULATION_AND_CODING_LUT = {
        ...
        # (3GPP TS 138.214 Version 15.3.0 Release 15)’. Valbonne, France: ETSI.
        # Table 5.2.2.1-2, and Table 5.2.2.1-3
        ...
        '5G': [
            ...
            ('5G', '1x1', 2, 'QPSK', 193, 0.3770, -4.7),
            ('5G', '1x1', 3, 'QPSK', 449, 0.8770, -2.3),
